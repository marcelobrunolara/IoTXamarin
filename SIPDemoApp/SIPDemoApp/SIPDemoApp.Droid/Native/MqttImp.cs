...
namespace SIPDemoApp.Droid.Native
{
    public class MqttImp : IMqtt
    {
        ...
        {
            client = new MqttClient(ipAdress, 16315, false, null, null, MqttSslProtocols.None);
        ...
        {
            PublishReceivedCallBack(e.Topic, Encoding.UTF8.GetString(e.Message));
        }
